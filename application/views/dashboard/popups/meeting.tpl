...
<div id="dialog-meeting" title="{$config.identity.orgname} Members' Meeting" style="display: none;">
	<p>
        The next {$config.identity.orgname} members' meeting is scheduled for {$meeting.date|date_format}. 
...
<div id="dialog-meeting-skip" title="{$config.identity.orgname} Members' Meeting" style="display: none;">
	<p>
